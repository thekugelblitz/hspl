...
<html lang="en">
  <head>
    ...
    <title>ClientArea - HostingSpell</title>
  ...
  <body>
    ...
    <div class="fullrock config sec-bg2 motpath">
      ...
      <section class="fullrock-content">
        <div class="container">
          <a href="index"><img class="svg logo-menu" src="img/logo.png" alt="logo HSPL"></a>
            ...
            <div class="tabs-header btn-select-customer">
              <ul class="btn-group btn-group-toggle" data-toggle="buttons">
                <li class="btn btn-secondary active mb-2">
                  <input type="radio" name="options" id="option1" checked> Already Registered?
                </li>
                <li class="btn btn-secondary">
                  <input type="radio" name="options" id="option2"> Create a New Account
                </li>
              </ul>
            </div>
            <div class="row">
                ...
                <div class="table tabs-item active">
                  <div class="cd-filter-block mb-0">
                    ...
                    <div class="cd-filter-content">
                      <form action="http://inebur.com/whmcs/dologin.php?goto=clientarea.php/?systpl=antler" method="post" class="comments-form">
                        <div class="row">
                          <div class="col-md-6">
                          ...
                          <div class="col-md-12 mt-5">
                            <button type="submit" value="login" id="login" class="btn btn-default-yellow-fill mt-0 mb-3 mr-3">Login <i class="fas fa-lock"></i>
                            </button>
                            <a class="golink mr-3">Forgot Password?</a>
                            <ul class="list d-inline">
                              <li>
                                <input name="rememberme" type="checkbox" id="checkbox" class="filter">
                                <label for="checkbox" class="checkbox-label c-grey" >Remember Me</label>
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="cd-filter-block mb-0">
                    ...
                    <div class="cd-filter-content">
                      <form action="http://inebur.com/whmcs/register.php/?systpl=antler" method="post" name="orderfrm" class="comments-form">
                        <div><small>Personal Information</small></div>
                        <div class="row mb-5">
                          <div class="col-md-6">
                        ...
                        <div class="row mb-5">
                          ...
                          <div><small>Account Security</small></div>
                          <div class="row mb-5">
                            <div class="col-md-6">
                          ...
                          <div><small>Security Answer</small></div>
                          <div class="row mb-5">
                            <div class="col-md-6">
                              <div class="cd-select mt-4">
